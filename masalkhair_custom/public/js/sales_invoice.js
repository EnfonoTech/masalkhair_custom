const MASALKHAIR_TRANSACTION_DOCTYPES = [
    { parent: "Sales Invoice", item: "Sales Invoice Item" },
    { parent: "Quotation", item: "Quotation Item" },
    { parent: "Sales Order", item: "Sales Order Item" },
    { parent: "Delivery Note", item: "Delivery Note Item" },
];

MASALKHAIR_TRANSACTION_DOCTYPES.forEach(function (doctypes) {
    frappe.ui.form.on(doctypes.parent, {
    ...
    frappe.ui.form.on(doctypes.item, {
